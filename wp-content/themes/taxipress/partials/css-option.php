...
if($ale_font_one) {
    if ($ale_font_one_ex) {
        ...
        $ale_font_one_ex = '';
        echo "<link href='http://fonts.googleapis.com/css?family=".$ale_font_one.$ale_font_one_ex."' rel='stylesheet' type='text/css'>";
    }
}
if($ale_font_two) {
    if ($ale_font_two_ex) {
        ...
        $ale_font_two_ex = '';
        echo "<link href='http://fonts.googleapis.com/css?family=".$ale_font_two.$ale_font_two_ex."' rel='stylesheet' type='text/css'>";
    }
}
if($ale_font_three) {
    if ($ale_font_three_ex) {
        ...
        $ale_font_three_ex = '';
        echo "<link href='http://fonts.googleapis.com/css?family=".$ale_font_three.$ale_font_three_ex."' rel='stylesheet' type='text/css'>";
    }
}
if($ale_font_four) {
    if ($ale_font_four_ex) {
        ...
        $ale_font_four_ex = '';
        echo "<link href='http://fonts.googleapis.com/css?family=".$ale_font_four.$ale_font_four_ex."' rel='stylesheet' type='text/css'>";
    }
}
if($ale_font_five) {
    if ($ale_font_five_ex) {
        ...
        $ale_font_five_ex = '';
        echo "<link href='http://fonts.googleapis.com/css?family=".$ale_font_five.$ale_font_five_ex."' rel='stylesheet' type='text/css'>";
    }
}
...
<style type='text/css'>
    ...
    <?php if($ale_font_two){?>
    .font_pacifico {
        <?php if($ale_font_two){$font_two = str_replace('+','',$ale_h6['face']); echo "font-family:".$h6family.";";};?>
    }
    <?php } ?>
