...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "Footer Call Text",
                        "desc" => "Insert the call text appear in footer after the call number",
                        "id" => "ale_footer_callus",
                        "std" => "",
                        "type" => "text");

    $options[] = array( "name" => "Footer Address Label",
                        "desc" => "Insert the Footer Address Label",
    ...
    $options[] = array( "name" => "Service Description",
                        "desc" => "Insert the description",
...
function aletheme_metaboxes($meta_boxes) {
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            array(
                'name' => 'title_one Description',
                'desc' => 'Insert the title_one',
                'id'   => $prefix . 'title_one',
                'std' => 'Taxi',
                'type' => 'text',
            ),
            array(
                'name' => 'title_two Description',
                'desc' => 'Insert the title_two',
                'id'   => $prefix . 'title_two',
                'std' => 'Press',
                'type' => 'text',
            ),
            array(
                'name' => 'title_address Description',
                'desc' => 'Insert the title_address',
            ...
            array(
                'name' => 'title_phone Description',
                'desc' => 'Insert the title_phone',
