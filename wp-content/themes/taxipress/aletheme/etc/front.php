...
function ale_enqueue_scripts() {
	...
	wp_register_script( 'html5-shim', 'https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
	// add modernizr
	wp_register_script( 'ale_modernizr', 'https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
